...
router.delete("/:id", async (req, res, next) => {
	try {
        ...
        res.status(204).end()
//no longer have a resource to return but it was deleted successfully - 204 means success but empty response
    } catch (err) {
		next(err);
	}
});
